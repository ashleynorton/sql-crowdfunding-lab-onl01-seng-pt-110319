...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.funding_goal, SUM(pledges.amount) FROM users INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING projects.funding_goal - SUM(pledges.amount) > SUM(pledges.amount) ORDER BY projects.title;"
end
